...
**As of 2026-08-12 (end of day):** read `DAILY_LOG.md` (newest entry first) for the actual day-by-day record — it is far more current and detailed than this section. In brief, the project now runs on:
...
- `HARD_RULES.md` (this branch) — 20 standing constraints now (Rule 20, added 11 Aug: never write directly to a OneDrive-synced file; copy to Desktop, work there, Shagun moves the final version herself). **Read this too, before touching any file.** `WDCO_MICROSOFT365_NOTES.md` (main branch, new 11 Aug) is the technical companion — OneDrive file-lock COM failures, in-cell "Place in Cell" images, clipboard fragility, PowerPoint COM quirks.
...
- Task Number 41 ("Build a new Fitout Scope document...") should be updated to reflect the 12 Aug progress above — substantially complete, not just "In Progress" in name only.
